...
public class CreateItemView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        spinMaxRange.setModel(new javax.swing.SpinnerNumberModel());

        spinMinRange.setModel(new javax.swing.SpinnerNumberModel());

        spinPrecision.setModel(new javax.swing.SpinnerNumberModel(0.5d, 0.0d, null, 1.0d));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CreateItemView().setVisible(true);
            }
        });
    }
