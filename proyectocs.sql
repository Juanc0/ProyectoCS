...
OrdAses_ItmC_id 	VARCHAR(45) 	NOT NULL 		REFERENCES item_cliente(ItmC_id),
OrdAses_Ases_id 	INT 		NOT NULL 		REFERENCES asesor(Ases_id),
PRIMARY KEY(OrdAses_Ordc_id, OrdAses_Ases_id,OrdAses_ItmC_id)
)ENGINE=InnoDB;
...
E_Cert_let 	VARCHAR(10) NOT NULL REFERENCES certificado(Cert_let),
...
Est_Cert_num 	INT NOT NULL  AUTO_INCREMENT REFERENCES certificado(Cert_num),
...
INSERT INTO cliente VALUES('800.194.600-3','AGROSAVIA','Luisa Gómez','Auxiliar de venta','2462544','2462544','AGROSAVIA@gmail.com','Bogotá','Km 14 vía Mosquera - Bogotá','4c15');
INSERT INTO cliente VALUES('0101','Creaciones y suministros','Alejandra Lozano', 'Directora comercial',' 9017160',' 9017160','creacionesysuministrossas@gmail.com','Bogotá','Carrera 67 No. 10-10','8c28');
INSERT INTO cliente VALUES ('900073613-2','CALIBRATION SERVICE SAS','','','2047699','2047699','calibrationservice@gmail.co', 'Bogotá','CARRERA 69 A No. 55- 16 SUR','7c02');
INSERT INTO cliente VALUES ('1030586792','4 KARNES','Fabian Avila','','5028751','5028751','karnes@gmail.co', 'Bogotá','Carrera 70b #3-45','5c21');


INSERT INTO orden_compra VALUES (default,'50°C, 75°C, 100°C, 150°C, 200°C', 'Caracterización','5', '725000','2019-06-18', '', 'EURAMENT-13','finalizado');
INSERT INTO orden_compra VALUES(default,'90 °C, 150 °C, 200 °C', 'Calibración','1', '300000','2019-09-11', '', 'Guía Técnica de Trazabilidad Metrológica e Incertidumbre de Medida en Caracterización Termica de Bannos y Hornos de Temperatura Controlada','finalizado');
INSERT INTO orden_compra VALUES(default,'2 °C,20°C, 40°C, 60°C, 70°C, 100°C,  150 °C,-20°C, -10 °C', 'Calibración','1', '400000','2019-08-22', '', 'Procedimiento para la calibración de Termómetros digitales  CEM-Edición digital','finalizado');
INSERT INTO orden_compra VALUES(default,'90°C, 150 °C,200 °C', 'Calibración','1', '350000','2019-08-22', '', 'TH-004','finalizado');
INSERT INTO orden_compra VALUES(default,'38%HR, 65%HR, 90%HR','Calibración','2','350000','2019-08-13','','"Procedimiento para la calibración de medidores de conciones ambientales de Temperatura y Humedad en aire"','finalizado');
INSERT INTO orden_compra VALUES(default,'90 °C, 150 °C, 180 °C', 'Calibración','1','400000','2019-09-11','','NTVVS 103','finalizado');
INSERT INTO orden_compra VALUES (default,'0°C, 5°C, 10°C, 20°C, 50°C, 70°C', 'Calibración','6', '1060000','2019-07-02', '', 'NT VVS 103','finalizado');
INSERT INTO orden_compra VALUES (default,'-10°C, 5°C, 10°C', 'Calibración','3', '420000','2019-07-02', '', 'TH 001','finalizado');
INSERT INTO orden_compra VALUES (default,'-30°C, -20°C, -10°C', 'Calibración','3', '420000','2019-07-02', '', 'TH 001','finalizado');
...
INSERT INTO orden_compra_asesor VALUES (default,'TDA-1','111');
...
INSERT INTO certificado VALUES ('0101','CH',1,'21','20.5','85.3','47.4');
INSERT INTO certificado VALUES ('0271','CMI',1,'24.2','20.8','67.6','45.5');
INSERT INTO certificado VALUES ('027','CMI',1,'24.2','20.8','67.6','46.5');
INSERT INTO certificado VALUES ('001','CMI',1,'23.6','22.0','74.0','55.0');
INSERT INTO certificado VALUES ('005','CMI',1,'22.3','21.1','48.2','46.5');
INSERT INTO certificado VALUES ('001','CTA',1,'24.6','20.3','61.3','48.4');
INSERT INTO certificado VALUES ('007','CTD',1,'24.3','23.4','67.3','54.8');
INSERT INTO certificado VALUES ('005','CTD',1,'22.8','21.6','56.8','48.5');
